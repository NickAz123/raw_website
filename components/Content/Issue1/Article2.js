  ...
  return (
    <div className={styles.articleContainer}>
      ...
      <div className={styles.articleContent}>
        ...
        <div className={styles.articleTitle}>Cigarette Courtesy</div>
        <div className={styles.articleText}>
          ...
          <p>
            During dinner service I went out to the back deck of the restaurant
            for my daily protein shake intake at around 8PM and met a couple of
            my colleagues there.{" "}
          </p>
          ...
          <p>
            I wondered if they sort of had a system of “borrowing” cigarettes
            since 15 of anything seems like a big ask. Is there some sort of
            unspoken rule that I’m not aware about? Again, I don’t smoke or
            anything so I don’t really know how expensive or inexpensive
            cigarettes could be. I just know that Canada doesn’t sell any
            Marlboro Reds and that it&apos;s a HOT commodity around here.
          </p>

          <p>
            But what was interesting to me is that the people I know that smoke
            are one of the most genuine and generous people that I know. I had
            to ask if they keep tabs on each other regarding how many they’ve
            bummed off or how many were bummed off of them and based on this
            conversation alone, they really don’t. My friend at work says that
            whenever he buys himself a pack, he usually buys an extra one just
            because he knows that people are bound to ask each other for a dart.
            Another friend mentioned that if he feels like he’s bummed a couple
            of darts that equate to a pack, he’ll just buy an extra pack to give
            him. This entire exchange, as mentioned earlier, speaks of immense
            levels of{" "}
            <span>
              <b>genuineness, comradery, community</b>
            </span>{" "}
            as well as{" "}
            <span>
              <b>generosity</b>
            </span>
            . There’s trust that’s built.{" "}
          </p>
          ...
          <p>
            ...
            last cigarettes, I learned to NEVER ask for the last cigarette since
            the last one always hits differently.
          </p>
          ...
          <p>
            ...
            greeting me with a “Good morning.” This was the closest thing I got
            to remembering what it feels like to have a girlfriend. I did give
            him a reel of Reds and in exchange he gave me <b>four joints</b>. I
            never understood why he wanted it so badly until I remembered that
            they don’t sell Marlboro Reds here for reasons I thought I knew. I
            thought it was for the same reason Canada stopped selling menthols
            which was to reduce the number of smokers but it’s purely a
            trademarking issue. I won’t go too crazy into detail, I just thought
            they stopped selling Reds here purely to prevent the increase of
            smokers but really it’s a trademark issue. In summary, they still
            sell Reds, just under the name “Rootop” which apparently still feels
            like your smoking lights. Think Coca-Cola vs the Coca-Cola you’d get
            in Mexico or in Asia.{" "}
          ...
          <p>
            We hope you enjoyed this newsletter and we’ll catch you on the next
            one.
          </p>
