...
import headerPhoto from "../../../../public/issue1/issue_1_article_3_img.JPG";
import mobilePhoto from "../../../../public/issue1/issue_1_article_3_mobile_img.JPG";
    ...
    <div className={styles.articleContainer}>
      ...
      <div className={styles.articleContent}>
        ...
        <div className={styles.articleText}>
          ...
          <p>
            I just finished watching The Bear on FX, <i>illegally</i>, and I
            cannot stress how much of a perfect show this is despite watching
            ...
            Being vulnerable, I’ve re-written this letter twice, as well as
            encountered a minor breakdown only because this industry is my life
            and I want to be able to fully encapsulate it in the way that I see
            it. I don’t want to talk about food, I want to talk about the areas
            in this show that some people would tend to overlook.{" "}
          </p>

          <p>
            I highly suggest all my friends and family to take the time to watch
            this show.{" "}
          </p>
          ...
          <p>
            To provide context, it’s about a young chef, Carmy, leaving the
            fine-dining scene (best restaurant in the world) and moving back to
            Chicago to take over his family sandwich shop after his older
            brother passed away.
          </p>

          <p>
            Now this family restaurant is your typical local community joint
            sustained by untrained cooks coming from different backgrounds all
            with their own struggles and stories, just like everyone else.
            <i> It’s the most normal shit ever. </i>
          </p>
          ...
          <p>
            The show highlights the anxieties, addictions, coping mechanisms
            that a lot of cooks face on a day to day basis and how it’s being
            managed. In episode 7, you’ll see what I mean. Episode 7 is the
            perfect description of how a perfectly normal day could immediately
            turn into a <i>melting pot of utter shit and chaotic distress. </i>
          </p>

          <p>
            There’s a lot to unpack after watching the Bear twice. Once for
            entertainment, second to study. Just to put this out there, it was
            kind of the first time I saw myself in a fictional tv character. Off
            the bat you can really tell that Carmy has not only an eye for food
            and its quality, but also has an eye for just really nice things.
            For example, in the beginning you see Carmy dealing with vintage
            americana. If you really want to dig deep, the restaurant scene has
          ...
          <p>
            Triggering because it brought me back to the time I was pulling in
            at least 55-60 hours weekly, not having control over what bullshit
            could happen during the day, or how I was meant to be learning but
            somehow felt the entire restaurant was resting on my shoulders
            thinking{" "}
            <i>“will this even lead me anywhere? Is this still worth it?”</i> Or
            moments where I found myself in the walk-in cooler having a
            breakdown mid-service whilst eating a freezie. I was fresh out of
            culinary school and was offered a junior-sous chef position at a
            restaurant that was failing internally. We were probably doing at
            least 250 covers daily with only 3 or 4 cooks and only 2 hours of
            prep time.
          </p>
